...
@WebServlet(name = "ServletDatosLimpieza", urlPatterns = {"/ServletDatosLimpieza"})
public class ServletDatosLimpieza extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("datoslimpieza.jsp");
